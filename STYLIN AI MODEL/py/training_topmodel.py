...
bottom_wear_types = ['Shirts', 'Tshirts', 'Blazers', 'Kurtas', 'Sweatshirts','Tops', 'Kurtis', 'Sweaters', 'Jackets']  # Adjust as necessary to match your dataset
data = data[data['subCategory'] == 'Topwear']
...
# Save the model
model.save('topwear_classifier_model.h5')
